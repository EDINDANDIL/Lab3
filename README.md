...
### 2. Описание классов и их параметров
...
`author` - поле `Book` в формате `String`, которое хранит имя автора.

`name` - поле `Book` в формате `String`, которое хранит название книги.

`volume` - поле `Book` в формате `int`, которое хранит кол-во страниц книги.
...
`cnt` - поле `BookList` в формате `int`, которое хранит кол-во книг.

`size` - поле `BookList` в формате `int`, которое хранит число, больше которого не может быть поле `cnt`(кол-во книг).   
...
`` - поле `BookList` в формате `int`, которое хранит кол-во книг.
